...
class FilerParser():
    ...
    def get_list_of_lines_from_file(self, input_file):
            with open(input_file) as f:
                return f.readlines()

    def get_declaration_lines_list(self, list_of_input_lines):
        declaration_lines = []
    ...
    def _get_start_element_number_of_each_block(self, list_of_all_lines):
        ...
        for line_number_element_in_list in range(0, len(list_of_all_lines)):
            if list_of_all_lines[line_number_element_in_list].startswith(self.OBJECT_PROPERTIES_STRING) and \
                    list_of_all_lines[line_number_element_in_list + 1].rstrip() == self.HASH_PATTERN:
                ...
                for element_number_in_block in range(object_properties_block_start_element_number, len(list_of_all_lines)):
                    if list_of_all_lines[element_number_in_block].rstrip() == self.HASH_PATTERN:
                        object_properties_block_end_element_number = element_number_in_block
                        break
                    else:
                        object_properties_block_end_element_number = len(list_of_all_lines)

            if list_of_all_lines[line_number_element_in_list].startswith(self.DATA_PROPERTIES_STRING) and list_of_all_lines[
                ...
                for element_number_in_block in range(data_properties_block_start_element_number, len(list_of_all_lines)):
                    if list_of_all_lines[element_number_in_block].rstrip() == self.HASH_PATTERN:
                        data_properties_block_end_element_number = element_number_in_block
                        break
                    else:
                        data_properties_block_end_element_number = len(list_of_all_lines)

            if list_of_all_lines[line_number_element_in_list].startswith(self.CLASSES_STRING) and \
                    list_of_all_lines[line_number_element_in_list + 1].rstrip() == self.HASH_PATTERN:
                classes_block_start_element_number = line_number_element_in_list + 2

                for element_number_in_block in range(classes_block_start_element_number, len(list_of_all_lines)):
                    if list_of_all_lines[element_number_in_block].rstrip() == self.HASH_PATTERN:
                        classes_block_end_element_number = element_number_in_block
                        break
                    else:
                        classes_block_end_element_number = len(list_of_all_lines)

            if list_of_all_lines[line_number_element_in_list].startswith(self.NAMED_INDIVIDUALS_STRING) and \
                    list_of_all_lines[line_number_element_in_list + 1].rstrip() == self.HASH_PATTERN:
                ...
                print 'list_of_all_lines:  ', list_of_all_lines[named_individuals_block_start_element_number]
                print 'len(list_of_all_lines): ', len(list_of_all_lines)

                # individualS block ends at eof
                named_individuals_end_element_number = len(list_of_all_lines)
